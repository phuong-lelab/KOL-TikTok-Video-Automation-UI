...
const GenerationBox: React.FC<GenerationBoxProps> = ({
  ...
  return (
    <div className="glass-panel hover-beam rounded-2xl p-6">
      ...
      <div className="bg-gray-900 rounded-xl mb-4 flex items-center justify-center overflow-hidden border-2 border-dashed border-gray-700 relative min-h-[200px]">
        {isGenerating ? (
